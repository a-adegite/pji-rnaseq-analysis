...
curl -L -C - ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR209/079/SRR20959679/SRR20959679_1.fastq.gz -o "${data_dir}SRR20959679_C_1.fastq.gz"
curl -L -C - ftp://ftp.sra.ebi.ac.uk/vol1/fastq/SRR209/079/SRR20959679/SRR20959679_2.fastq.gz -o "${data_dir}SRR20959679_C_2.fastq.gz"
...
curl -L -C - ftp:// -o SRR20959683_GSM6435901_A-PJI01_Staphylococcus_aureus_RNA-Seq
